 ...
 *
 * PermissionGrantBuilderImp ensures the correct PermissionGrant implementation
 * is returned, this reduces the
 */
class PermissionGrantBuilderImp extends PermissionGrantBuilder
    implements Serializable
{
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        if( hasDomain )
        {
            ...
            domain = new WeakReference<ProtectionDomain>( null );
        }
        else
        {
            domain = null;
