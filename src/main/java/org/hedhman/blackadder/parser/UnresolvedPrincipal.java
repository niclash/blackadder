...
final class UnresolvedPrincipal implements Principal
{
     ...
     */
    static final String WILDCARD = PrincipalEntry.WILDCARD;
    ...
    public boolean equals( Object that )
    {
        if( that instanceof UnresolvedPrincipal )
        {
            ...
            if( name == null )
            {
                if( klass.equals( up.klass ) && up.name == null )
                {
                    return true;
                }
                else
            ...
            {
                if( klass.equals( up.klass ) && name.equals( up.name ) )
                {
                    return true;
                }
                else
        ...
        return that instanceof Principal && implies( (Principal) that );
    }
