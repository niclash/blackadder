 ...
 * may not be updated in the policy until {@link java.security.Policy#refresh()} is called.
 *
 ...
 * Serializable.  See http://wiki.apache.org/river/Serialization
 *
...
public abstract class PermissionGrant
{
    ...
    PermissionGrant( Permission[] permissions )
    {
        decorated = null;
        ...
        else
        {
            ...
            Set<Permission> result = new TreeSet<Permission>( new PermissionComparator() );
            ...
            this.perms = Collections.unmodifiableSet( result );
     ...
     *
     * @return true if this PermissionGrant is given for the ProtectionDomain
     */
     ...
     * and Principal's.
     *
     * @param codeSource the codeSource to check if this grant is for
     * @param principals the principals to check if this grant is for
     *
     * @return true if this grant is provided for the given codeSource and principals.
     */
    public abstract boolean implies( CodeSource codeSource, Principal[] principals );
    ...
    public final Collection<Permission> getPermissions()
    {
        if( decorated() != null )
        {
            return decorated().getPermissions();
        }
        return perms;
    }
